...
## [0.22.0](https://github.com/edwardlthompson/aetherfeed/compare/v0.21.0...v0.22.0) (2026-08-18)


### Added

* add coach layer and complete bootstrap defaults ([2f77fb9](https://github.com/edwardlthompson/aetherfeed/commit/2f77fb9a65ad1f1f963e69e276d43972e57b54e5))
* add first-run backlog and Windows upgrade-sim gates ([14811be](https://github.com/edwardlthompson/aetherfeed/commit/14811be2f4290841e8bf99bbd002facc50ff8e6e))
* add in-app About screen with format-locked update checker ([29278cc](https://github.com/edwardlthompson/aetherfeed/commit/29278ccad8f1e7ee623e3c761026bbc4711a83a3))
* add industry-standard repo hygiene automation ([136bfe3](https://github.com/edwardlthompson/aetherfeed/commit/136bfe336e3f868c9f32c12e531ea26517765cc2))
* add portable first-run tour and multi-agent adapters ([7944f1b](https://github.com/edwardlthompson/aetherfeed/commit/7944f1b2a76322c5b96dc666922fa0c88d0ce628))
* **agent:** add prior-art thin steals and clear High Dependabot ([80dc2a6](https://github.com/edwardlthompson/aetherfeed/commit/80dc2a60caab73a9b1c097e97a5ee9dce4d54c20))
* **agents:** automate BUILD_PLAN human gates and Sprint M8 CI ([810e259](https://github.com/edwardlthompson/aetherfeed/commit/810e259ceb69994800372d2f66df09c918465738))
* **agents:** autonomous /build with HUMAN/ADB automation ([cdea429](https://github.com/edwardlthompson/aetherfeed/commit/cdea429beecea4c9cf2e099d4fbea7b4e873f9f7))
* **agents:** execute Sprint M13 human-gate automation ([4fddec8](https://github.com/edwardlthompson/aetherfeed/commit/4fddec8aa677ab5f873a86e88dbb56bb5082bc46))
* **agents:** execute Sprint M14 post-M13 review remediation ([fc71433](https://github.com/edwardlthompson/aetherfeed/commit/fc71433fcbfeae3c15703adedde7970106c80c90))
* **agents:** execute Sprint M15 P2 backlog and archive M14 ([a5f3199](https://github.com/edwardlthompson/aetherfeed/commit/a5f3199255d5f897aa960da92cdcf6b09c0579df))
* **agents:** execute Sprint M9 sequential rows 1-7 ([e8e6831](https://github.com/edwardlthompson/aetherfeed/commit/e8e6831f3367f41fce5cb22f25c7d07347034e98))
* **agents:** execute Sprint M9-8 and M10 code review remediation ([9163dab](https://github.com/edwardlthompson/aetherfeed/commit/9163dab255d4a7552ea1d0d4f169f2b78f569593))
* **agents:** finish Sprint M15 instrumented CI and SBOM release wiring ([4d5993d](https://github.com/edwardlthompson/aetherfeed/commit/4d5993df6602186f479de0fff0b2395ecb5860c3))
* **agents:** incremental feature assembly and autonomous agent gates ([3d47485](https://github.com/edwardlthompson/aetherfeed/commit/3d4748595589a642db0373947ae2152e5e3cd1de))
* **agents:** parallel-first BUILD_PLAN and auto multi-agent dispatch ([f0a0b2f](https://github.com/edwardlthompson/aetherfeed/commit/f0a0b2fd0b93aa3a6aebdf38992c0337265cd7a2))
* **android:** add F-Droid device dry-run scripts (M28) ([fb90878](https://github.com/edwardlthompson/aetherfeed/commit/fb9087846d424b088d37ed4e77ee13c672e9c0b6))
* **android:** add system bar insets and 3-button nav compensation ([cc946af](https://github.com/edwardlthompson/aetherfeed/commit/cc946af6eb590db574815de69e2ad955e993b250))
* **branding:** add branding kit and pitch README generator ([2488b09](https://github.com/edwardlthompson/aetherfeed/commit/2488b0962f0921e855c0c5afe6ed5af15a1337a1))
* **commands:** add /cleanup to archive BUILD_PLAN rows after build ([d7ab7fc](https://github.com/edwardlthompson/aetherfeed/commit/d7ab7fc96d411be36ead3f1d31dc433041c30bb2))
* **commands:** add batch instruction templates (M27) ([4fe713a](https://github.com/edwardlthompson/aetherfeed/commit/4fe713a51335c576058fc0e435bd419a272e8b8e))
* **cursor:** integrate 3.9-3.11 surfaces and local-first compute ([5d2d129](https://github.com/edwardlthompson/aetherfeed/commit/5d2d12920f68dc23e02071cfe2e43f04bd924f31))
* **cursor:** integrate FOSS hooks, skills, subagents, and feature radar (M30) ([1cd2b72](https://github.com/edwardlthompson/aetherfeed/commit/1cd2b726e8ac6a63cadfa5e63851e935fe1f53ac))
* **cursor:** quiet agent shell with Python hooks and agent-run ([7fc8e4b](https://github.com/edwardlthompson/aetherfeed/commit/7fc8e4b455655acb68c5037e364ada7454177d01))
* design system, web layout docs, and Golden Path UI refresh ([912ebbe](https://github.com/edwardlthompson/aetherfeed/commit/912ebbe2c57fb2d47223c49b3332f3037cc9c80f))
* **docs:** add Cursor mode routing and repo sanity gates (M19-M25) ([9782e75](https://github.com/edwardlthompson/aetherfeed/commit/9782e757d95d06a27b1d03db27faf2a978e3c9c9))
* harden Windows PATH, Unreleased fold, and ship gates ([8eab392](https://github.com/edwardlthompson/aetherfeed/commit/8eab392edff967bbc0cfabb89aff0902a6b8ac0e))
* initial agent-project-bootstrap template v0.1.0 ([d71c23c](https://github.com/edwardlthompson/aetherfeed/commit/d71c23c22dd97b96f3ef91435319d5df04bb28b6))
* **limits:** adopt static data 300L and pure logic 150L taxonomy ([49c7407](https://github.com/edwardlthompson/aetherfeed/commit/49c740719cfe8eb760a7d3cb4e675769cb296d27))
* **m16-p2:** prune-optional smoke, a11y, i18n test fix, lightroom prune ([0212a19](https://github.com/edwardlthompson/aetherfeed/commit/0212a194012e884490e44d1f0194ed48756e9754))
* **m18-p2:** complete post-sequential backlog — tests, gates, CI, SW cache ([d2e088d](https://github.com/edwardlthompson/aetherfeed/commit/d2e088de9d7f97813a0ca66d4c4b3335455bf853))
* **m18:** remediate post-P2 review — Pages base path, Android apply, init config ([9105ebb](https://github.com/edwardlthompson/aetherfeed/commit/9105ebb129e660c288c65f6bef3ee7a67aeec4dd))
* **p2:** complete M17 P2 backlog — a11y, updates, CI, docs ([64ec578](https://github.com/edwardlthompson/aetherfeed/commit/64ec578a352d6d771c8d774d68da93f0fd01467d))
* **python:** enforce pytest in CI and workflow gates ([ec3939f](https://github.com/edwardlthompson/aetherfeed/commit/ec3939f8569f95083643e20fba8970b13e0e180a))
* **quality:** Codex review, multi-stack autofix, expanded /prerelease ([13cbb5d](https://github.com/edwardlthompson/aetherfeed/commit/13cbb5d5d4c1bbb84f08032bc692d292869e4485))
* **release:** auto-merge Release Please PRs via workflow and script ([0e817c3](https://github.com/edwardlthompson/aetherfeed/commit/0e817c370bc44a01320815ee9cd266573b99b507))
* seed AetherFeed as a local-first Android and Windows client ([fe5b85a](https://github.com/edwardlthompson/aetherfeed/commit/fe5b85a25b954adfcc3ef6aa5d5e4690f5020715))
* template v0.2.0 with UTF-8 gates, lockfiles, and build verification ([2317440](https://github.com/edwardlthompson/aetherfeed/commit/2317440eeecec0ef961bb9cf54ea3830c183d8cf))


### Fixed

* add gradle.properties with android.useAndroidX for assembleDebug ([ea87f7d](https://github.com/edwardlthompson/aetherfeed/commit/ea87f7dfd40500a7550759fb4466418de5ed2aae))
* **agents:** execute Sprint M11 post-M10 hardening ([daa9d85](https://github.com/edwardlthompson/aetherfeed/commit/daa9d858afe0eed78e95913107af704e652fb964))
* **agents:** execute Sprint M12 post-M11 polish ([0f859fd](https://github.com/edwardlthompson/aetherfeed/commit/0f859fd5211e06d06647760cccde452402254614))
* Android CI — google maven for AGP and FOSS grep comment false positive ([b907c46](https://github.com/edwardlthompson/aetherfeed/commit/b907c46628f05275ecefb149bc230ea08ac47845))
* **android:** ApkDownloadHelperTest uses file-as-parent path on Unix CI ([be237e7](https://github.com/edwardlthompson/aetherfeed/commit/be237e7d99778624ca3fe0c3a9b54ef8db74a856))
* **android:** bump compileSdk to 37 for androidx 1.19 dependencies ([3a74f0c](https://github.com/edwardlthompson/aetherfeed/commit/3a74f0c08d32aff7a14d6fb7eff829578cbe73da))
* **android:** migrate Golden Path example to AGP 9 built-in Kotlin ([a84a16c](https://github.com/edwardlthompson/aetherfeed/commit/a84a16c8fa7e67d3179b820962aead03add7be34))
* **android:** pin androidx.test runner/rules to published 1.6.1 ([5195c46](https://github.com/edwardlthompson/aetherfeed/commit/5195c463cbb219d490915a901bf350687b2dd98d))
* **android:** pin Kotlin compose plugin 2.3.20 for CodeQL ([7055255](https://github.com/edwardlthompson/aetherfeed/commit/70552559df7dd57d8f9ad7d2ee334ee4f6759c04))
* **android:** read INTERNET permission from PackageInfo in test ([5d9be3e](https://github.com/edwardlthompson/aetherfeed/commit/5d9be3e9f3144468f84e2bdca0121788582e930c))
* **android:** rewrite Gradle Kotlin DSL files as UTF-8 ([11bc782](https://github.com/edwardlthompson/aetherfeed/commit/11bc78233b804ccaaca318f630f9eb1501cf10b8))
* **android:** Robolectric-safe UpdateApplierTest on Windows ([38635a3](https://github.com/edwardlthompson/aetherfeed/commit/38635a3d7948d0e592833c63612a76c3069b4314))
* **android:** test UpdateApplier intent build without startActivity ([27259c6](https://github.com/edwardlthompson/aetherfeed/commit/27259c65261fc44eac696565d01022e6f49c5ccd))
* **android:** write test APK under FileProvider cache-path ([f59023c](https://github.com/edwardlthompson/aetherfeed/commit/f59023cc342d456a653d27643a250ce9957b6abf))
* bind vite preview to 127.0.0.1 for Playwright CI and extend pre-commit encoding ([9a3f935](https://github.com/edwardlthompson/aetherfeed/commit/9a3f9357ab4ca2d2afcdf8250ce955a6f46e9c60))
* **changelog:** keep a single Unreleased section ([dcbea94](https://github.com/edwardlthompson/aetherfeed/commit/dcbea948a8cd0f3b49891bb1add66aa796906808))
* **changelog:** remove duplicate Unreleased section for CI gate ([4c82890](https://github.com/edwardlthompson/aetherfeed/commit/4c8289072c7db231063be65e2a263be05f4af0bc))
* **ci:** gofmt Go example and harden PR coverage comment parsing ([0423990](https://github.com/edwardlthompson/aetherfeed/commit/0423990b4ece9559a42db6c6bc66cec0eab518c8))
* **ci:** heal Dependabot merge CI gap and automate M32 human gates ([4d195a2](https://github.com/edwardlthompson/aetherfeed/commit/4d195a2ed8944610fbdb011313f2fd9692c7445c))
* **ci:** index release automerge paths; correct bypass docs ([5d4682d](https://github.com/edwardlthompson/aetherfeed/commit/5d4682d0ab6307005a584761534233d212104e2b))
* **ci:** index setup-automerge-token in TEMPLATE_INDEX ([e532c20](https://github.com/edwardlthompson/aetherfeed/commit/e532c209a03e562db051588af2e1fc0193381850))
* **ci:** move optional job existence checks into path-changes job ([f7213ec](https://github.com/edwardlthompson/aetherfeed/commit/f7213eca78069907a08f181de996f516f9fa5341))
* **ci:** pin Kotlin for CodeQL and repair weekly health workflow ([66d58f6](https://github.com/edwardlthompson/aetherfeed/commit/66d58f62767adc51b4b10c749d324baf1b2509e0))
* **ci:** re-pin Kotlin 2.3.20 for CodeQL after Dependabot [#26](https://github.com/edwardlthompson/aetherfeed/issues/26) ([42f4659](https://github.com/edwardlthompson/aetherfeed/commit/42f4659d373b8bd07172c6d091ebf02b6bebfb11))
* **ci:** remove job-level hashFiles guards from ci.yml ([36fdbc1](https://github.com/edwardlthompson/aetherfeed/commit/36fdbc118f25e5865fb18aee653728ee87613f09))
* **ci:** repair corrupted template literals in coverage comment job ([a64ad04](https://github.com/edwardlthompson/aetherfeed/commit/a64ad04b1fd5ec301110925d8783ed8a1653a6ab))
* **ci:** repair M12 gate failures (TS tests, Kotlin pin) ([cb1c5d5](https://github.com/edwardlthompson/aetherfeed/commit/cb1c5d5a51793daa0377c9f82ea84affc7b9d222))
* **ci:** repair workflow action SHAs, e2e selectors, and shell line endings ([38ce003](https://github.com/edwardlthompson/aetherfeed/commit/38ce003771c04cdc043ffc79bf8ee2296fac19aa))
* **ci:** run android instrumented gradle in single shell script ([976a87f](https://github.com/edwardlthompson/aetherfeed/commit/976a87ffda747d952a024f82623d8622cbce89dd))
* **ci:** scope design cohesion checks to active example stacks ([5130309](https://github.com/edwardlthompson/aetherfeed/commit/513030942117f1b3f93f8402ed40e12e1c2ae095))
* **ci:** stabilize PWA apply e2e and about-feature-gate for appBootstrap ([8946089](https://github.com/edwardlthompson/aetherfeed/commit/8946089ed2c265c1a5e4cd7996dea328b1a8c6e5))
* **ci:** use full git history for Gitleaks on Release Please PRs ([01d585b](https://github.com/edwardlthompson/aetherfeed/commit/01d585bcc1183633139cf46d4ca4932c3dbd8ee3))
* **ci:** use stack-presence job for conditional Python matrix ([ce6bfb3](https://github.com/edwardlthompson/aetherfeed/commit/ce6bfb3aa839fff8b75088e1c98f874ded2d89de))
* clear remaining Sprint 0 CI failures. ([031b156](https://github.com/edwardlthompson/aetherfeed/commit/031b1561e9786a1ff53766f9a75965ef1d9b3cfa))
* correct gh api calls in validate-workflow-actions.sh ([100df56](https://github.com/edwardlthompson/aetherfeed/commit/100df5649aee5724b22a70c84742453a106f1f1a))
* **cursor:** harden hook validation and complete M31 audit ([cd21e5a](https://github.com/edwardlthompson/aetherfeed/commit/cd21e5a70e8d2848bcbdf9d22b1e62daccff55c1))
* **deps:** cap undici override at 7.x for jsdom compat ([24b240f](https://github.com/edwardlthompson/aetherfeed/commit/24b240f325b6b42363f638a2067c8a005b7c798a))
* **deps:** override transitive tmp and uuid for @lhci/cli alerts ([222fb59](https://github.com/edwardlthompson/aetherfeed/commit/222fb59f5aa2d11b66c79496c23ad0980108b620))
* **deps:** override undici to close Dependabot CVE alerts ([e1e9790](https://github.com/edwardlthompson/aetherfeed/commit/e1e9790c16fd0c95cbf25d056d9c6f8bff59cf61))
* **docs:** index cursor-modes rule and align START_HERE paths (M26) ([8bbf689](https://github.com/edwardlthompson/aetherfeed/commit/8bbf68973260799ff6292416509590e37991246d))
* **docs:** index template version sync scripts in TEMPLATE_INDEX ([367b650](https://github.com/edwardlthompson/aetherfeed/commit/367b650a1cd490f3ca181c42aaa4fe79020278cf))
* **e2e:** stabilize PWA apply test — assert button visibility only ([bda25d2](https://github.com/edwardlthompson/aetherfeed/commit/bda25d25cfed80f16ad7835df56c68a5eac4e458))
* extend encoding scan to Android kts/kt/xml/properties ([8f52c55](https://github.com/edwardlthompson/aetherfeed/commit/8f52c550f52231520c76dd0a12326c0838db07e4))
* ignore pruned stack links in the docs gate ([d7a3ba0](https://github.com/edwardlthompson/aetherfeed/commit/d7a3ba099736f2194e08ec5d4d75ae6c4704935c))
* import rp_merge_status from cwd-relative scripts/lib ([df322af](https://github.com/edwardlthompson/aetherfeed/commit/df322af79d3302457f6dad26fac0d2e424544a15))
* improve CI configs for python packaging and vitest ([36fbb39](https://github.com/edwardlthompson/aetherfeed/commit/36fbb394c5c1aa414c812334aa8628abfc47f178))
* **init:** skip design-token sync for pruned example stacks ([1844483](https://github.com/edwardlthompson/aetherfeed/commit/184448395220b7dc104dcf85c81b8f1f3e313bba))
* keep portable-purpose test valid after child init stamp ([5084b4b](https://github.com/edwardlthompson/aetherfeed/commit/5084b4b07542c583371e2e4e0277ac81731f42c1))
* **m16:** tag-gate jobs-only poll, SBOM version assert, CI parity ([3f071cb](https://github.com/edwardlthompson/aetherfeed/commit/3f071cb9608910cb765ba5b465b3dfa6743df3dc))
* **m17:** INTERNET permission, update timing, prune index, release CI gate ([96829ae](https://github.com/edwardlthompson/aetherfeed/commit/96829aea0af3ff24a6942a9add8f9fb4c2e2364f))
* normalize Android example UTF-16 files for Gradle CI ([39a78d3](https://github.com/edwardlthompson/aetherfeed/commit/39a78d36844739a9b5b77cb1f9876feb229accca))
* normalize UTF-16 index.html and extend encoding scan to html/css ([e16272e](https://github.com/edwardlthompson/aetherfeed/commit/e16272eded9901380c086dad4da6189e548209f4))
* playwright preview server host and timeout for CI e2e ([99188fa](https://github.com/edwardlthompson/aetherfeed/commit/99188faff52638196366aa8f967cfa832900e37e))
* **release:** automate version sync and SBOM dispatch (M29) ([8b7d62e](https://github.com/edwardlthompson/aetherfeed/commit/8b7d62ecbe5ee0fa4d1572fd870495bf51936460))
* **release:** guard empty release-please pr output on merge push ([1d1b56c](https://github.com/edwardlthompson/aetherfeed/commit/1d1b56c3010a7e048e9ca4fe197eb2b284d3df26))
* **release:** parse Release Please PR number from JSON output ([57201aa](https://github.com/edwardlthompson/aetherfeed/commit/57201aa03595979196dff79c5c0327e7e70f4725))
* **release:** SBOM backfill from main; add template version sync gate ([d3b4c05](https://github.com/edwardlthompson/aetherfeed/commit/d3b4c057db7470593244f46ed5d3dc9c04468a99))
* **release:** skip pre-release gate for SBOM backfill dispatch ([ac1377c](https://github.com/edwardlthompson/aetherfeed/commit/ac1377c15840f428c6ec36095a4f7ac820d4f88b))
* repair Security Scan workflow and add GH CI automation ([80f9fc0](https://github.com/edwardlthompson/aetherfeed/commit/80f9fc03a5ada9ef795b39111d2de6b508a982c6))
* resolve CI failures in web lint, python format, and android grep ([444ad7b](https://github.com/edwardlthompson/aetherfeed/commit/444ad7b4c713257bb749371c7c9882b0e883bd19))
* **scripts:** stub settings preferences when verifying About removal ([d6b92a2](https://github.com/edwardlthompson/aetherfeed/commit/d6b92a2c31c464bdd6595dcd49adf7fe305020e1))
* **security:** clear Dependabot npm High/Moderate alerts ([647e4ed](https://github.com/edwardlthompson/aetherfeed/commit/647e4ede6fecfcd4278e3cb5b4708fdd9b621069))
* **security:** clear High npm alerts and harden plan critiques ([2b119a7](https://github.com/edwardlthompson/aetherfeed/commit/2b119a78f088f91077ff96f3657c622bc9755395))
* **security:** override postcss &gt;=8.5.18 in examples/node ([981ee64](https://github.com/edwardlthompson/aetherfeed/commit/981ee64ae64560394f4cb8e0614ab6589610e60b))
* stabilize Lighthouse CI with 3-run median ([f41c48d](https://github.com/edwardlthompson/aetherfeed/commit/f41c48daff6d8a148d86ba5cfabf800d015c806d))
* strip CR from jq paths in template-index gate ([812a2db](https://github.com/edwardlthompson/aetherfeed/commit/812a2db71bca3929334d913848826bedffb4d80f))
* sync template version files to 0.11.0 for release PR ([5fe0fc1](https://github.com/edwardlthompson/aetherfeed/commit/5fe0fc1f0359238f9884b32c519496ba9d59e990))
* treat OWNER/REPO placeholder as unset for update checks ([2721c01](https://github.com/edwardlthompson/aetherfeed/commit/2721c01d0cf4adb36ecf123aeb42c0c6429a5e80))
* unblock Sprint 0 CI gates after the AetherFeed seed. ([366e0d5](https://github.com/edwardlthompson/aetherfeed/commit/366e0d551ea8e358fa6e308ce1f3ae699b97dd2d))
* **upgrade-sim:** skip full bootstrap validation after prune pass ([1634917](https://github.com/edwardlthompson/aetherfeed/commit/1634917f35ee9137ffb56b5c3a6e763025819ed7))
* **web:** assign narrowed HTMLDivElement for AppShell root ([f1dad83](https://github.com/edwardlthompson/aetherfeed/commit/f1dad832e03f2adda807a99fadc63e314d0d833c))
* **web:** lock proxy-agent 8 so npm ci matches browsers override ([be4333b](https://github.com/edwardlthompson/aetherfeed/commit/be4333baa5dcf65044d03bc365aead8b939172e6))
* **web:** narrow app root type for AppShell render ([53406b1](https://github.com/edwardlthompson/aetherfeed/commit/53406b1b84736d145ebf620a5852a6d6eb23c087))
* **web:** override js-yaml to patch Dependabot alert [#9](https://github.com/edwardlthompson/aetherfeed/issues/9) ([609165c](https://github.com/edwardlthompson/aetherfeed/commit/609165c6321cb2498c39541b5315ff19a533f7fb))
* **web:** resolve CI lint and file-size budget failures ([1759a8f](https://github.com/edwardlthompson/aetherfeed/commit/1759a8f54b80f54564318e4174f56388d20047ef))
* **web:** use hasAttribute for disabled check in panelDialog ([f4d082e](https://github.com/edwardlthompson/aetherfeed/commit/f4d082ea1331446f45baeabd77f55818ec5a8cdf))


### Changed

* **deps-dev:** Bump the web-dependencies group ([#25](https://github.com/edwardlthompson/aetherfeed/issues/25)) ([62278a1](https://github.com/edwardlthompson/aetherfeed/commit/62278a14710173c01194c4a386f26bfc568f2b19))
* **deps-dev:** Bump the web-dependencies group ([#34](https://github.com/edwardlthompson/aetherfeed/issues/34)) ([c3b88a6](https://github.com/edwardlthompson/aetherfeed/commit/c3b88a697782dab40beba72019146ad743ff9d31))
* **deps-dev:** Bump the web-dependencies group across 1 directory with 3 updates ([#16](https://github.com/edwardlthompson/aetherfeed/issues/16)) ([9be673a](https://github.com/edwardlthompson/aetherfeed/commit/9be673a9239b35d685c9df46ad95bfc1a0bd170a))
* **deps-dev:** Bump the web-dependencies group across 1 directory with 5 updates ([40f1ff8](https://github.com/edwardlthompson/aetherfeed/commit/40f1ff879ec039beeff60e666e6c0ced5d582705))
* **deps-dev:** Bump the web-dependencies group across 1 directory with 5 updates ([a558aca](https://github.com/edwardlthompson/aetherfeed/commit/a558aca42ae2d828b6582fced733feafd438cd3b))
* **deps-dev:** Bump vite ([#32](https://github.com/edwardlthompson/aetherfeed/issues/32)) ([e1aca21](https://github.com/edwardlthompson/aetherfeed/commit/e1aca21ea6d515840ad00a73054dbff5883b514a))
* **deps-dev:** Bump vite ([#40](https://github.com/edwardlthompson/aetherfeed/issues/40)) ([2f0c4ab](https://github.com/edwardlthompson/aetherfeed/commit/2f0c4ab69684620cbab9b7a8fb3326b3506c486b))
* **deps:** Bump androidx.compose:compose-bom ([#30](https://github.com/edwardlthompson/aetherfeed/issues/30)) ([a0a4ff0](https://github.com/edwardlthompson/aetherfeed/commit/a0a4ff0ee23d22f44f3911c2b635d4bacf58689f))
* **deps:** Bump com.android.application ([#38](https://github.com/edwardlthompson/aetherfeed/issues/38)) ([dfa93c9](https://github.com/edwardlthompson/aetherfeed/commit/dfa93c97a9cc73504d8a2a684b737938143e33cb))
* **deps:** Bump org.jetbrains.kotlin.plugin.compose ([#26](https://github.com/edwardlthompson/aetherfeed/issues/26)) ([84952c2](https://github.com/edwardlthompson/aetherfeed/commit/84952c26ceb365a412acfe22a3468679bd104055))
* **deps:** Bump org.jetbrains.kotlin.plugin.compose ([#28](https://github.com/edwardlthompson/aetherfeed/issues/28)) ([df7a3ba](https://github.com/edwardlthompson/aetherfeed/commit/df7a3ba8c324eafd6f64267163b9a9c865e25d9f))
* **deps:** Bump the android-dependencies group across 1 directory with 2 updates ([cec8ce1](https://github.com/edwardlthompson/aetherfeed/commit/cec8ce1704a4fa7e235ebb02eb06ca2d9b32fcf2))
* **deps:** Bump the android-dependencies group across 1 directory with 2 updates ([2208c34](https://github.com/edwardlthompson/aetherfeed/commit/2208c34b7f95cbe76b68987e1511faab428ca11e))
* **deps:** Bump the android-dependencies group across 1 directory with 3 updates ([5ea63fd](https://github.com/edwardlthompson/aetherfeed/commit/5ea63fd32634365566d5b5b4460848c3ce8b512d))
* **deps:** Bump the android-dependencies group across 1 directory with 3 updates ([d65fc74](https://github.com/edwardlthompson/aetherfeed/commit/d65fc748bff2a83869165c5d1a8ea458122653dc))
* **deps:** Bump the android-dependencies group across 1 directory with 9 updates ([#18](https://github.com/edwardlthompson/aetherfeed/issues/18)) ([200770c](https://github.com/edwardlthompson/aetherfeed/commit/200770c034507ba50b2bd90cd6e0aba45842bd42))
* **deps:** Bump the github-actions group across 1 directory with 10 updates ([#3](https://github.com/edwardlthompson/aetherfeed/issues/3)) ([648f5d2](https://github.com/edwardlthompson/aetherfeed/commit/648f5d202b1b2820e10b59c680b6980109290f77))
* **deps:** Bump the github-actions group across 1 directory with 12 updates ([c70ce00](https://github.com/edwardlthompson/aetherfeed/commit/c70ce00d5d2bd89525aa928ef279ffe66d82e720))
* **deps:** Bump the github-actions group across 1 directory with 12 updates ([c242785](https://github.com/edwardlthompson/aetherfeed/commit/c2427853e0aec0c0680b68beb0497cbed4da7e8c))
* **deps:** Bump the github-actions group across 1 directory with 3 updates ([a1910d1](https://github.com/edwardlthompson/aetherfeed/commit/a1910d121b0839548902968c0bbacdb76ce19c8e))
* **deps:** Bump the github-actions group across 1 directory with 3 updates ([6e1c174](https://github.com/edwardlthompson/aetherfeed/commit/6e1c1746bef119b22fb4e82d42b99c303b3b6c42))
* **deps:** Bump the github-actions group across 1 directory with 3 updates ([#22](https://github.com/edwardlthompson/aetherfeed/issues/22)) ([a118247](https://github.com/edwardlthompson/aetherfeed/commit/a118247a43a3a698315885423d13803ac2d40a71))
* **deps:** Bump the github-actions group with 2 updates ([#35](https://github.com/edwardlthompson/aetherfeed/issues/35)) ([97f98cf](https://github.com/edwardlthompson/aetherfeed/commit/97f98cfa4ff6f1844498c953bba70fe6e7b0ee45))
* **deps:** Bump the github-actions group with 2 updates ([#41](https://github.com/edwardlthompson/aetherfeed/issues/41)) ([2dfa0c1](https://github.com/edwardlthompson/aetherfeed/commit/2dfa0c15361a9e29a568e6b8d45c61a9183ff8c1))
* **deps:** Bump the node-dependencies group ([389ab2f](https://github.com/edwardlthompson/aetherfeed/commit/389ab2f19061a20174bf76748da545701572d296))
* **deps:** Bump the node-dependencies group ([#31](https://github.com/edwardlthompson/aetherfeed/issues/31)) ([829a79a](https://github.com/edwardlthompson/aetherfeed/commit/829a79a3bbb9f8a153f15379f7af31010fadf334))
* **deps:** Bump the node-dependencies group ([#33](https://github.com/edwardlthompson/aetherfeed/issues/33)) ([edc6127](https://github.com/edwardlthompson/aetherfeed/commit/edc61273e77328854cdfe8e191f8f30432216ae4))
* **deps:** Bump the node-dependencies group ([#39](https://github.com/edwardlthompson/aetherfeed/issues/39)) ([ad302c9](https://github.com/edwardlthompson/aetherfeed/commit/ad302c96fbe34edbd489938c25a2bdeafcb2d17c))
* **deps:** Bump the node-dependencies group across 1 directory with 4 updates ([dbba532](https://github.com/edwardlthompson/aetherfeed/commit/dbba532ac842ea5cccc9e9d93bdba3c621b7156a))
* **deps:** Bump the node-dependencies group across 1 directory with 4 updates ([5196514](https://github.com/edwardlthompson/aetherfeed/commit/5196514daf41bc9bf56dcbac08ecf0a8cc6ff839))
* **deps:** Bump the node-dependencies group across 1 directory with 5 updates ([#17](https://github.com/edwardlthompson/aetherfeed/issues/17)) ([5bb9730](https://github.com/edwardlthompson/aetherfeed/commit/5bb973038e2ee3ec9d89dbad859e68651c3bb4a7))
* **deps:** Bump the node-dependencies group in /examples/node with 2 updates ([42b87eb](https://github.com/edwardlthompson/aetherfeed/commit/42b87eb548942b4197fe67194698d1eaf49028e4))
* **main:** release 0.10.0 ([90d5933](https://github.com/edwardlthompson/aetherfeed/commit/90d59332f35d9e10b2b4f5a4185199c5c347f463))
* **main:** release 0.10.0 ([5e78720](https://github.com/edwardlthompson/aetherfeed/commit/5e787200dd74477883fad22640ab8fa8804ebf47))
* **main:** release 0.11.0 ([6d4f4ac](https://github.com/edwardlthompson/aetherfeed/commit/6d4f4ac1fabf0cff863a9508500644ec413326f4))
* **main:** release 0.11.0 ([cbe38ed](https://github.com/edwardlthompson/aetherfeed/commit/cbe38ed7c0529d366dd55219fd776c0fa7f2f6bf))
* **main:** release 0.11.1 ([26d774c](https://github.com/edwardlthompson/aetherfeed/commit/26d774c6dd6dc4249e4c1df65d51973c7a142f69))
* **main:** release 0.11.1 ([5c7bba2](https://github.com/edwardlthompson/aetherfeed/commit/5c7bba2217c69af7c4b4f173497e6e63000d6e18))
* **main:** release 0.12.0 ([04a151c](https://github.com/edwardlthompson/aetherfeed/commit/04a151c7ff356df83624c8908051889c7491e1ef))
* **main:** release 0.12.0 ([77f64c6](https://github.com/edwardlthompson/aetherfeed/commit/77f64c6bae9ce7425e4fe23ffa69463330ce6fba))
* **main:** release 0.13.0 ([44ca556](https://github.com/edwardlthompson/aetherfeed/commit/44ca556f3661acae44cadbef55ced667b87f3373))
* **main:** release 0.13.0 ([c66ccfc](https://github.com/edwardlthompson/aetherfeed/commit/c66ccfc602976791aa673b43494a7b9e163b0f50))
* **main:** release 0.13.1 ([7823600](https://github.com/edwardlthompson/aetherfeed/commit/78236009f23619f386b8b5459080755a5ad78f1d))
* **main:** release 0.13.1 ([1e08b2b](https://github.com/edwardlthompson/aetherfeed/commit/1e08b2bbfbe1d102d540f9eba27702544410d9d4))
* **main:** release 0.13.2 ([ff8e4e6](https://github.com/edwardlthompson/aetherfeed/commit/ff8e4e64b364002bee5a98e4307d27a9db6d74ca))
* **main:** release 0.13.2 ([2add7b8](https://github.com/edwardlthompson/aetherfeed/commit/2add7b8710a8e0b3c56a2f7cdc6091d1d4301a0c))
* **main:** release 0.14.0 ([4b94298](https://github.com/edwardlthompson/aetherfeed/commit/4b942982dfe8e8dca4216c22cf0d37419ef9d6d7))
* **main:** release 0.14.0 ([7e3184d](https://github.com/edwardlthompson/aetherfeed/commit/7e3184df334a9c2b54324ce8fbc4aed04b10bec3))
* **main:** release 0.14.1 ([a6c6be1](https://github.com/edwardlthompson/aetherfeed/commit/a6c6be1ecf865df58678b3bb2265ec566bbee49a))
* **main:** release 0.14.1 ([88256f7](https://github.com/edwardlthompson/aetherfeed/commit/88256f788910fac0b218f8008656f03c497059d7))
* **main:** release 0.15.0 ([2e010ae](https://github.com/edwardlthompson/aetherfeed/commit/2e010aec4d81cdcad6492230512fe1bebef1fd1f))
* **main:** release 0.15.0 ([05a8847](https://github.com/edwardlthompson/aetherfeed/commit/05a884716b3f31de5229978797602745bcf72ea6))
* **main:** release 0.15.1 ([f5d3c9d](https://github.com/edwardlthompson/aetherfeed/commit/f5d3c9df1c70130617469a6253e904430a31b504))
* **main:** release 0.15.1 ([23fb927](https://github.com/edwardlthompson/aetherfeed/commit/23fb9277eeb2f57483948c3fa99ff52686d545bf))
* **main:** release 0.15.2 ([634d06d](https://github.com/edwardlthompson/aetherfeed/commit/634d06d1fecda1219bd1be45ffdf9786bcae63a7))
* **main:** release 0.15.2 ([a6ce9a8](https://github.com/edwardlthompson/aetherfeed/commit/a6ce9a81b47b40200591e78e262059cbf4b0e4b6))
* **main:** release 0.16.0 ([34c4dfc](https://github.com/edwardlthompson/aetherfeed/commit/34c4dfcc951fac770da4c5bab711d6a6f1bbaabb))
* **main:** release 0.16.0 ([0271646](https://github.com/edwardlthompson/aetherfeed/commit/0271646f9e45ec474e28913db30caa36b93268fb))
* **main:** release 0.17.0 ([701cd24](https://github.com/edwardlthompson/aetherfeed/commit/701cd24a03e96e60309aeda312eb9e41babc539e))
* **main:** release 0.17.0 ([87c26c0](https://github.com/edwardlthompson/aetherfeed/commit/87c26c0b2fb4a80eb677db98705a25a1605af657))
* **main:** release 0.18.0 ([3f0b5a3](https://github.com/edwardlthompson/aetherfeed/commit/3f0b5a320dbbe1f71d79e6064fcd7a13f1e1f2dc))
* **main:** release 0.18.0 ([638aaa4](https://github.com/edwardlthompson/aetherfeed/commit/638aaa47bb81530d52981083145536db1b427227))
* **main:** release 0.18.1 ([fe80fea](https://github.com/edwardlthompson/aetherfeed/commit/fe80feab5f96af25496f86674c42bd1a88e22835))
* **main:** release 0.18.1 ([b7da01d](https://github.com/edwardlthompson/aetherfeed/commit/b7da01d2ba488c51ada6d05d94e2b65d83d79d45))
* **main:** release 0.18.2 ([7d46e68](https://github.com/edwardlthompson/aetherfeed/commit/7d46e6838f0c2075b7adda27c90971b776c6144a))
* **main:** release 0.18.2 ([9ec0382](https://github.com/edwardlthompson/aetherfeed/commit/9ec0382e036b6a994c78de8ce7e8b9179c93d9b6))
* **main:** release 0.18.3 ([013e688](https://github.com/edwardlthompson/aetherfeed/commit/013e688ca1854bdc2f95369ce140309a3834d776))
* **main:** release 0.18.3 ([4246ba8](https://github.com/edwardlthompson/aetherfeed/commit/4246ba8691947ae68c7f667f19de748076a7b86b))
* **main:** release 0.19.0 ([2bef8ac](https://github.com/edwardlthompson/aetherfeed/commit/2bef8ac46c4d497aa37960b7ac4df34f6e893cee))
* **main:** release 0.19.0 ([4bb3643](https://github.com/edwardlthompson/aetherfeed/commit/4bb3643cb3ca1fed36d79ec363fb380658d8ddf7))
* **main:** release 0.20.0 ([b570f07](https://github.com/edwardlthompson/aetherfeed/commit/b570f077e6ad62963f316848458afaa9caf70a3e))
* **main:** release 0.20.0 ([eebd703](https://github.com/edwardlthompson/aetherfeed/commit/eebd70300b45ac215ba4b874d65065bf24cc5075))
* **main:** release 0.21.0 ([1525cd6](https://github.com/edwardlthompson/aetherfeed/commit/1525cd627dfa3fd6f8203c0d646a94cbe132ba50))
* **main:** release 0.21.0 ([621dfcb](https://github.com/edwardlthompson/aetherfeed/commit/621dfcbd3d3d35e4744542dbb3dffc791f85427f))
* **main:** release 0.7.0 ([a40ff7b](https://github.com/edwardlthompson/aetherfeed/commit/a40ff7be662d16906b917d7b3c57b20acbdd8378))
* **main:** release 0.7.0 ([144ed33](https://github.com/edwardlthompson/aetherfeed/commit/144ed33bdf931fb96fd1799beb89242f6b773d09))
* **main:** release 0.7.1 ([259a45f](https://github.com/edwardlthompson/aetherfeed/commit/259a45f73e1e107896ec248e9010f1363ffe9fdd))
* **main:** release 0.7.1 ([041ab85](https://github.com/edwardlthompson/aetherfeed/commit/041ab85c97239fa1a8423ca6efdafa0313d9a51b))
* **main:** release 0.8.0 ([10b46d6](https://github.com/edwardlthompson/aetherfeed/commit/10b46d6364e89092173b1385960d3f5eb2c66a04))
* **main:** release 0.8.0 ([f17b216](https://github.com/edwardlthompson/aetherfeed/commit/f17b216a058dfdb340bb8854485640b1f57c0c75))
* **main:** release 0.9.0 ([fd699bc](https://github.com/edwardlthompson/aetherfeed/commit/fd699bc5aa7c12d4b9e814e89faf50787f6c0726))
* **main:** release 0.9.0 ([fd699bc](https://github.com/edwardlthompson/aetherfeed/commit/fd699bc5aa7c12d4b9e814e89faf50787f6c0726))
* **main:** release 0.9.0 ([1190f4c](https://github.com/edwardlthompson/aetherfeed/commit/1190f4cd2ad4cfa65c1f68fb4ec704087c08004a))
* release v0.2.1 full bootstrap hardening ([a2749a3](https://github.com/edwardlthompson/aetherfeed/commit/a2749a30cfac1b3bf3f2d450666592453ca3aca2))
* **release:** prepare v0.13.2 release ([9932753](https://github.com/edwardlthompson/aetherfeed/commit/9932753e34b7ace26fa1aab1cd671c7b6b281896))
* **release:** prepare v0.14.1 release ([6cad442](https://github.com/edwardlthompson/aetherfeed/commit/6cad442d9d91ff0ca92a37ad05bf6217229edd21))
* **release:** prepare v0.18.1 release ([b4fca9c](https://github.com/edwardlthompson/aetherfeed/commit/b4fca9c1fb7014b96d95649e285916f23d9cd2e0))
* **release:** prepare v0.18.3 release ([afbea39](https://github.com/edwardlthompson/aetherfeed/commit/afbea39e98346091d9524f04ba1ae0e85b8ed389))
* **release:** sync version files to 0.10.0 ([36a02e4](https://github.com/edwardlthompson/aetherfeed/commit/36a02e4569d4d26bcacbc95b8e27a991a634d5b4))
* **release:** sync version files to 0.9.0 for tag gate ([cafb088](https://github.com/edwardlthompson/aetherfeed/commit/cafb088b95a60be922e161ba793368880bc3981d))
* **security:** triage Scorecard SARIF and archive M35 HUMAN items ([23254e8](https://github.com/edwardlthompson/aetherfeed/commit/23254e85c4b2ae9b4feff5daf6a08c0e6deec19e))
* **security:** triage Scorecard SARIF and archive M35 HUMAN items ([132612d](https://github.com/edwardlthompson/aetherfeed/commit/132612d8b2005e0c80437695fccd868f48c2c861))
* sync template version files for release PR ([92f46a2](https://github.com/edwardlthompson/aetherfeed/commit/92f46a286a675367c7dacbd44e472e0ac6f9f035))
* sync template version files for release PR ([22d1806](https://github.com/edwardlthompson/aetherfeed/commit/22d1806d629daf2dab3774bda4b82fc81bf16eb4))
* sync template version files for release PR ([d8891f1](https://github.com/edwardlthompson/aetherfeed/commit/d8891f1d4dd010f7bd52c7aebd3801d8caa3374b))
* sync template version files for release PR ([3ff0d9c](https://github.com/edwardlthompson/aetherfeed/commit/3ff0d9c28476a2b52a07b51878be1b855db5a134))
* sync template version files for release PR ([4f34b53](https://github.com/edwardlthompson/aetherfeed/commit/4f34b5302b61327cb97bdaabbb5a7055e0b4213e))
* sync template version files for release PR ([f890ba7](https://github.com/edwardlthompson/aetherfeed/commit/f890ba78b9b1e6377d29f845405a8623dac31336))
* sync template version files for release PR ([f85124e](https://github.com/edwardlthompson/aetherfeed/commit/f85124ee9b17d7255e6dc53c8df49eb12037a386))
* sync template version files for release PR ([2246a4f](https://github.com/edwardlthompson/aetherfeed/commit/2246a4f6ce8926586e89c5ed3072e6161615a7ac))
* sync template version files for release PR ([8dd56e4](https://github.com/edwardlthompson/aetherfeed/commit/8dd56e4ae3b209dd5fb79e50af2a1eb29b6a35dc))
* sync template version files for release PR ([9dd5257](https://github.com/edwardlthompson/aetherfeed/commit/9dd525716f274400189cef730d3d305106339f61))
* sync template version files for release PR ([6a1d8b6](https://github.com/edwardlthompson/aetherfeed/commit/6a1d8b6ca7cd51c8e9d658354b8cd518a0ec1b39))
* sync template version files for release PR ([13aa938](https://github.com/edwardlthompson/aetherfeed/commit/13aa93857f8035e42bea66564db77e4bfadf2995))
* sync template version files for release PR ([4326a5d](https://github.com/edwardlthompson/aetherfeed/commit/4326a5d178a5528d8c09a8bbbf22ed91aa247f0b))
* sync template version files for release PR ([71e974a](https://github.com/edwardlthompson/aetherfeed/commit/71e974a76826b2bb9cf647d04821efd59e834afd))
* sync template version files for release PR ([834f9ff](https://github.com/edwardlthompson/aetherfeed/commit/834f9ff4fc6ff292ad8c635cce6b56cadbb65770))
* sync template version files for release PR ([8026431](https://github.com/edwardlthompson/aetherfeed/commit/80264316835df6fe010d9ba55a2fcadd60d31305))
* sync template version files for release PR ([ad9c217](https://github.com/edwardlthompson/aetherfeed/commit/ad9c217a91fe3a6562a259de95b40dfcb8665016))
* sync template version files for release PR ([245d508](https://github.com/edwardlthompson/aetherfeed/commit/245d508cd98134f3c402d2c93ff5fd0f7a94617f))
* sync template version files for release PR ([0fe5b57](https://github.com/edwardlthompson/aetherfeed/commit/0fe5b575e776c102f775aea031b737b0cebe6ac2))
* sync template version to 0.7.1 and fix CHANGELOG encoding ([e7ebf2d](https://github.com/edwardlthompson/aetherfeed/commit/e7ebf2dadc367ceec14f701bd927a20b7c4dcde0))
* sync v0.7.0 and complete BUILD_PLAN automation pass ([369e17e](https://github.com/edwardlthompson/aetherfeed/commit/369e17ea198e671a4e0cec5943282e6f5e1f2786))


### Documentation

* archive M28 weekly maintain audit ([d6de099](https://github.com/edwardlthompson/aetherfeed/commit/d6de09991776cd54298fec2358a2534ba825f477))
* **build-plan:** add Sprint M16 from post-M15 code review ([88050db](https://github.com/edwardlthompson/aetherfeed/commit/88050db8ce8c74a6bbee825ec3f4aab0ace60d36))
* **build-plan:** add Sprint M17 from post-M16 code review ([7cdc92b](https://github.com/edwardlthompson/aetherfeed/commit/7cdc92b6cc95f5961e46c37234bd5c2a8aada9e3))
* **build-plan:** archive human branding visual review for v0.17.0 ([f3f7e00](https://github.com/edwardlthompson/aetherfeed/commit/f3f7e00a0726dce75bd989a5732bd40c1f059c31))
* **build-plan:** archive M18 sprint body; slim active board ([2e3a4dd](https://github.com/edwardlthompson/aetherfeed/commit/2e3a4ddea0aab5dffdd01cb44c6e76f335c562d3))
* **build-plan:** archive M32 audit sprint after CI green ([2157d0b](https://github.com/edwardlthompson/aetherfeed/commit/2157d0bde69ebda696035ea198d4bc40f03bc16f))
* **build-plan:** archive Sprint M16 and slim active board ([7e4a50e](https://github.com/edwardlthompson/aetherfeed/commit/7e4a50e24efa48c984f6d905af070a5e890825e0))
* **build-plan:** archive Sprint M17 and slim active board ([047e8e7](https://github.com/edwardlthompson/aetherfeed/commit/047e8e7e3cca2c3ab24155ff92cfeb27f85e0a23))
* **build-plan:** archive v0.13.2 release and slim active board ([2b708ca](https://github.com/edwardlthompson/aetherfeed/commit/2b708ca7313076b19524cf1d989ea3b8f6ed7cd7))
* **build-plan:** mark M12 CI sign-off complete on 7055255 ([3189747](https://github.com/edwardlthompson/aetherfeed/commit/31897474dec6b30b1ee7f95701f3cebecc9c249b))
* **build-plan:** mark M14 CI sign-off complete on fc71433 ([0419e62](https://github.com/edwardlthompson/aetherfeed/commit/0419e621a9a99e7f34fc31f32b5dd19a30437345))
* **build-plan:** mark M15 CI sign-off complete on a5f3199 ([2ab8bca](https://github.com/edwardlthompson/aetherfeed/commit/2ab8bca6a192ca421fb12b715bfd1e43c32f5ca9))
* **build-plan:** mark M16 row 10 CI sign-off complete ([7846d96](https://github.com/edwardlthompson/aetherfeed/commit/7846d9604d84dd3c2d916482e5fabeeb7e0bafeb))
* **build-plan:** mark M18 sequential complete after CI green @ 2721c01 ([d4f7b82](https://github.com/edwardlthompson/aetherfeed/commit/d4f7b82a8c8200e626ed21575cb7734c2a9a9b9b))
* **build-plan:** record v0.9.0 human release approval ([40e6eee](https://github.com/edwardlthompson/aetherfeed/commit/40e6eee079a9e8469993cb68f14d60d5329ca14c))
* **build-plan:** unify repo-wide checklist status markers ([2370c0e](https://github.com/edwardlthompson/aetherfeed/commit/2370c0e68d0871a3b646644d588d5779c944f0b1))
* **build:** record GitHub repo security setup as complete ([23d2df0](https://github.com/edwardlthompson/aetherfeed/commit/23d2df07e03b3ddbe72f0a86be9a89e20b590172))
* **changelog:** note postcss override in Unreleased security fix ([96c8fd0](https://github.com/edwardlthompson/aetherfeed/commit/96c8fd07892051df0e8ccff0ebcb7932b59c9ba3))
* harden initialization prompt against CI failure patterns ([ec5ee91](https://github.com/edwardlthompson/aetherfeed/commit/ec5ee914332e7697e6168676c88eaca341cff643))
* **kb:** record npm ci lockfile miss after browsers override ([33e961f](https://github.com/edwardlthompson/aetherfeed/commit/33e961f857764ffd8f0f78f0b7a7e44c8073ede5))
* log autonomous /build milestone in memory and decision log ([508a541](https://github.com/edwardlthompson/aetherfeed/commit/508a54103349d5b91b193913636afffaf3be6562))
* log M27 batch commands decision at ship milestone ([17318ea](https://github.com/edwardlthompson/aetherfeed/commit/17318ea250d191b5eb9b477c2239d992a809a04a))
* mark automated BUILD_PLAN gates complete after CI green ([f3013a0](https://github.com/edwardlthompson/aetherfeed/commit/f3013a06f9ff1c9e7f5d5a85e96f495065a0610a))
* mark Sprint M6 repo-hygiene CI gate complete ([7ed666b](https://github.com/edwardlthompson/aetherfeed/commit/7ed666ba8c4b482f948b22a8e29e87dad2cef2e1))
* mark v0.2.1 About and release human tasks complete ([33dc47f](https://github.com/edwardlthompson/aetherfeed/commit/33dc47fa934728a4b1b0247e14af95e95d031db0))
* record v0.10.0 SBOM backfill complete ([f78dd18](https://github.com/edwardlthompson/aetherfeed/commit/f78dd185fed55d2e5b225c7c5a55f5f8e637eaeb))
* refresh README with badges, TOC, and collapsible sections ([008140e](https://github.com/edwardlthompson/aetherfeed/commit/008140ed6eed951a788cfdb1832f5b035bb7a582))
* **release:** archive M33 and v0.15.0 after /ship ([69de879](https://github.com/edwardlthompson/aetherfeed/commit/69de879396fb6387decffd5184e5bbd700fb7f40))
* **release:** archive v0.14.1 and update memory after /push ([4cf495b](https://github.com/edwardlthompson/aetherfeed/commit/4cf495b99f9a3f4a99ccf8a65eb8faf7c63e15df))
* **release:** archive v0.15.2 and update memory after /ship ([619e456](https://github.com/edwardlthompson/aetherfeed/commit/619e45675ec288c6067d0487f0289f6b53039f16))
* **release:** archive v0.16.0 ship memory and decisions ([90ce3db](https://github.com/edwardlthompson/aetherfeed/commit/90ce3db8b678ec43cf53701d0c81a31afbe3345a))
* **release:** archive v0.17.0 branding kit ship memory and decisions ([7b5fa0d](https://github.com/edwardlthompson/aetherfeed/commit/7b5fa0dfce8893d86610f205e695ce6a62b587f7))
* **release:** archive v0.18.0 ship memory and decisions ([54909bc](https://github.com/edwardlthompson/aetherfeed/commit/54909bc8447bc767de70c297361771eff50592d4))
* **release:** archive v0.18.1 ship memory and decisions ([83daf53](https://github.com/edwardlthompson/aetherfeed/commit/83daf53c2a403514f673d95f9fb30b2341dc73dd))
* **release:** archive v0.18.2 ship memory and decisions ([9ce74d1](https://github.com/edwardlthompson/aetherfeed/commit/9ce74d177ab0dce65170df2ece370142907227e0))
* **release:** archive v0.18.3 ship memory and decisions ([3b572d8](https://github.com/edwardlthompson/aetherfeed/commit/3b572d823820e4ed2bd0a4c6729da98ae925b573))
* **release:** archive v0.19.0 ship memory and decisions ([3e55a0b](https://github.com/edwardlthompson/aetherfeed/commit/3e55a0b2b1a896cea8c699a4ba612274b91729d5))
* **release:** archive v0.20.0 ship memory and decisions ([f54927e](https://github.com/edwardlthompson/aetherfeed/commit/f54927eb378a5e413f6b8346f2699ba0ef19ea58))
* **release:** archive v0.21.0 ship memory and decisions ([55fd2b8](https://github.com/edwardlthompson/aetherfeed/commit/55fd2b8b8efc0b34bdd332d5bd60f6e2743e9188))
* restore DECISION_LOG seed line order after v0.14.1 archive ([22cada9](https://github.com/edwardlthompson/aetherfeed/commit/22cada93c8105712e2f9286c05424e642268f044))
* rewrite template README as a first-run pitch ([01e21fc](https://github.com/edwardlthompson/aetherfeed/commit/01e21fc0f559a56e09b69172e0d06b763ed11d75))
