package org.aetherfeed.app.ui.insets
...
fun NavigationModeProvider(content: @Composable () -> Unit) {
    ...
    if (BuildConfig.DEBUG) {
        ...
        Log.d("AetherFeed", "navMode=$mode navInsetBottom=${measured}px")
    }
...
fun navigationModeLabelRes(mode: NavigationMode): Int = when (mode) {
    NavigationMode.ThreeButton -> org.aetherfeed.app.R.string.nav_mode_three_button
    NavigationMode.TwoButton -> org.aetherfeed.app.R.string.nav_mode_two_button
    NavigationMode.Gesture -> org.aetherfeed.app.R.string.nav_mode_gesture
    NavigationMode.Unknown -> org.aetherfeed.app.R.string.nav_mode_unknown
}
